...
.DESCRIPTION
    ...
    Memory design:
    - Append-only files under .memory/对话记录 and .memory/系统记录 never use this script
    - Stable live files under .memory/知识提炼 and .memory/全局知识地图.md use MEMORY mode
    - Historical copies named *_v*.md must live under .history/.memory, not under .memory
