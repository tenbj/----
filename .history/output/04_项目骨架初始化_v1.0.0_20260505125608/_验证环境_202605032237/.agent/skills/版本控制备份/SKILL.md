...
```powershell
powershell -ExecutionPolicy Bypass -File "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\skills\版本控制备份\scripts\backup.ps1" `
...
```powershell
powershell -ExecutionPolicy Bypass -File "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\skills\版本控制备份\scripts\backup.ps1" `
    -TargetPath "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\output\减肥第一性原理_202605031505\核心理论_v1.0.0.md" `
    -ChangeType PATCH
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\skills\版本控制备份\scripts\backup.ps1" `
    -TargetPath "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\rules\version-control-rules.md" `
    -Mode CONFIG
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\skills\版本控制备份\scripts\backup.ps1" `
    -TargetPath "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\skills\版本控制备份" `
    -Mode FOLDER
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.agent\skills\版本控制备份\scripts\backup.ps1" `
    -TargetPath "E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\.memory\全局知识地图.md" `
    -Mode MEMORY `
    -ChangeType MINOR
```
...
```
E:\my_project\知识研究\output\04_项目骨架初始化_202605032237\_验证环境_202605032237\
├── output\                              ← 当前工作文件（带版本号）
...
- `.agent/rules/` 与 `.agent/skills/` 的备份仍使用时间戳
