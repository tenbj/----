...
if (Test-Path $agents) {
    # Keep this list aligned with output/09_项目检查标准*/02_.agents目录完整性.
    # 课题研究 and 项目规范化 are first-class project skills, not extras.
...
if (Test-Path $mem) {
    ...
    $allowedDirs = @($S_conv, $S_sys_rec, $S_knowledge, ".system")
