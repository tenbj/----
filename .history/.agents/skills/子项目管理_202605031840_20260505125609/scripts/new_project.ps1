...
.DESCRIPTION
    ...
    output\{Number}_{Topic}_{YYYYMMDDHHMI}
...
.EXAMPLE
    ...
    # Creates: output\01_减肥第一性原理_202605031528\
#>
...
# Calculate next project number from existing output folders
...
$folderName = "${projectNumber}_${Topic}_${timestamp}"
