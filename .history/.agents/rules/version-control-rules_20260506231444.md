...
| `framework-check.ps1` | `.agents/skills/框架体检/scripts/framework-check.ps1` |
| `normalize.ps1` | `.agents/skills/项目规范化/scripts/normalize.ps1` |
| `remove.ps1` | `.agents/skills/记忆管理/scripts/remove.ps1` |
